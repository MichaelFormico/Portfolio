  ...
  return (
    ...
    >
      ...
      <div
        ...
        }  absolute top-0 left-0 w-full h-full flex flex-col justify-between items-center text-gray-100 md:p-2 transition-all duration-500 ease-in-out`}
      >
        <div className="top-0 left-0 w-full text-center lg:pt-2">
          <p
